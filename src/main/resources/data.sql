...
insert into ad (start_date, end_date, limit_km, cdw, car_id, price_list_id, location, owner_id, visible) value ('2020-06-01','2020-07-30','0',false,3,2, 'Beograd',3, true);
...
insert into ad (start_date, end_date, limit_km, cdw, car_id, price_list_id, location, owner_id, visible) value ('2020-04-01','2020-04-30','700',false,5,5, 'Novi Sad',6, true);
insert into ad (start_date, end_date, limit_km, cdw, car_id, price_list_id, location, owner_id, visible) value ('2020-06-01','2020-07-18','0',false,6,5, 'Novi Sad',6, true);
...
insert into user_can_post_comment ( user_id, car_id, posted, request_end_date) value ( 8, 1, false, '2020-06-06');

insert into user_can_rate (user_id, car_id, rated, request_end_date) value (3, 1, false, '2020-06-05');
insert into user_can_rate (user_id, car_id, rated, request_end_date) value (8, 1, false, '2020-06-06');
