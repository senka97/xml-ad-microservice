...
insert into price_list (alias, discount20Days, discount30Days, price_per_day, price_per_km,owner_id) value ('Price list - owner 6', 10, 20, 30, 4, 6);
...
insert into ad (start_date, end_date, limit_km, cdw, car_id, price_list_id, location, owner_id, visible) value ('2020-06-03','2020-06-19','500',false,4,3, 'Novi Sad',6, true);
insert into ad (start_date, end_date, limit_km, cdw, car_id, price_list_id, location, owner_id, visible) value ('2020-06-01','2020-06-30','700',false,5,2, 'Beograd',3, true);
insert into ad (start_date, end_date, limit_km, cdw, car_id, price_list_id, location, owner_id, visible) value ('2020-06-01','2020-06-18','0',false,6,3, 'Novi Sad',6, true);
